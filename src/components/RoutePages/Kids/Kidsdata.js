...
export const FashionEssentials = [
  {
    image:
...
export const ExploreMore = [
  ...
  },
  {
    ...
    category: "active-wear-store",
  },
];

export const KidsSpace = [
  {
    image:
